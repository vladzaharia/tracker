...
export const MIGRATION_4_CONFIG: Migration = {
	...
	up: async (db: D1Database) => {
		await db.exec(
			`CREATE TABLE IF NOT EXISTS config (id TEXT PRIMARY KEY, name TEXT NOT NULL, description TEXT NOT NULL, value TEXT NOT NULL, format TEXT NOT NULL, editable INTEGER NOT NULL);`
		)
