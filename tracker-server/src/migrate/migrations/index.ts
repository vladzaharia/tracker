...
export function getAllMigrations(): Migration[] {
	return [MIGRATION_0_INITIAL, MIGRATION_1_EXISTING_TRIPS, MIGRATION_2_WAYPOINTS, MIGRATION_3_ADD_WAYPOINTS, MIGRATION_4_CONFIG, MIGRATION_5_OIDC_CONFIG, MIGRATION_6_MAPBOX_CONFIG]
}
